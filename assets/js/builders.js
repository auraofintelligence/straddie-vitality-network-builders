  ...
  window.VITALITY_BUILDERS = [
    {
      ...
      fields: [
        ...baseMeta,
        { name: "projectName", label: "Project name", type: "text", group: "Project identity", placeholder: "e.g. Amity Sauna Pilot, Venue HBOT Readiness, Community Recovery Hub" },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "topic", label: "Topic", type: "select", group: "Evidence focus", options: [["HBOT", "HBOT"], ["Sauna / heat exposure", "Sauna / heat exposure"], ["Food and movement", "Food and movement"], ["Dementia and ageing", "Dementia and ageing"], ["Toxicity / exposure", "Toxicity / exposure"], ["Athletic performance", "Athletic performance"], ["Access and inclusion", "Access and inclusion"], ["Funding or policy", "Funding or policy"]] },
        ...sourceTrailFields,
        ...
        { name: "publicLine", label: "Public wording", type: "textarea", group: "Public-safe summary", rows: 4, placeholder: "A cautious sentence suitable for public pages, grant notes or media briefs." },
        { name: "questionsRaised", label: "Questions this raises", type: "textarea", group: "Next actions", rows: 4, placeholder: "What should a venue, clinician, researcher, council, sponsor or community reviewer ask next?" },
        ...boundaryFields
      ]
    },
    {
      ...
      description: "Checks whether a venue could host sauna, HBOT, food, movement or recovery activity.",
      ...
      fields: [
        ...
        { name: "serviceFit", label: "Service fit", type: "checkbox-group", group: "Venue identity", options: [["hbot", "HBOT"], ["sauna", "Sauna"], ["food", "Healthy food"], ["movement", "Exercise / movement"], ["recovery", "Recovery or rest"], ["education", "Education or workshops"], ["noticeboard", "Public notices"]] },
    ...
    },
    {
      ...
      description: "Collects HBOT device, supervision, safety, claim and deployment notes.",
      claimBoundary: "HBOT claims require qualified health review. Public pages must not promote unsupervised home use or unproven treatment claims.",
      fields: [
        ...baseMeta,
        ...
        { name: "deviceStatus", label: "Device status", type: "textarea", group: "Risk, safety and approvals", rows: 3, placeholder: "Device type, ARTG/TGA status if known, pressure, oxygen delivery, supplier, service plan, operating instructions." },
        ...
        { name: "fireSafety", label: "Fire and oxygen safety", type: "textarea", group: "Risk, safety and approvals", rows: 4, placeholder: "Grounding, clothing, no ignition sources, device instructions, training, emergency procedure, reporting pathway." },
        ...
        ...sourceTrailFields,
        { name: "publicLine", label: "Public-safe HBOT line", type: "textarea", group: "Public-safe summary", rows: 3, placeholder: "Use cautious wording. Example: HBOT is being explored as a supervised health technology with strict safety and evidence review." },
        ...boundaryFields,
        { name: "nextSteps", label: "Next HBOT checks", type: "textarea", group: "Next actions", rows: 4, placeholder: "Clinical reviewer, regulator check, supplier evidence, insurer, venue, safety drill, source update." }
      ]
    },
    {
      id: "sauna-model",
      ...
      fields: [
        ...
        { name: "wellbeingUse", label: "Wellbeing use", type: "textarea", group: "Public-safe summary", rows: 4, placeholder: "Relaxation, social connection, winter tourism, athletic heat adaptation, recovery routine, healthy ageing support." },
        { name: "safetyPlan", label: "Heat safety and screening", type: "textarea", group: "Risk, safety and approvals", rows: 4, placeholder: "Hydration, heat limits, alcohol policy, medical cautions, staff supervision, cleaning, privacy, emergency response." },
        ...
        ...sourceTrailFields,
        { name: "athleteAngle", label: "Athlete or performance angle", type: "textarea", group: "Evidence and source trail", rows: 3, placeholder: "Heat acclimation, endurance, recovery, scheduling after exercise, coach or health-professional review." },
        ...boundaryFields,
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "routineParts", label: "Routine parts", type: "checkbox-group", group: "Routine identity", options: [["sauna", "Sauna / heat"], ["hbot", "HBOT"], ["food", "Healthy food"], ["movement", "Movement"], ["rest", "Rest"], ["hydration", "Hydration"], ["social", "Social connection"], ["education", "Education"], ["source-trail", "Source trail"]] },
        ...
        { name: "detoxBoundary", label: "Detox wording boundary", type: "textarea", group: "Evidence and source trail", rows: 4, placeholder: "What can be said about exposure, sweating, recovery or repair without overclaiming toxin removal?" },
        { name: "screening", label: "Safety screening", type: "textarea", group: "Risk, safety and approvals", rows: 4, placeholder: "Heat risk, pressure risk, hydration, medication, cardiovascular cautions, mobility, anxiety, consent." },
        ...sourceTrailFields,
        ...boundaryFields,
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "healthLink", label: "Health and wellbeing link", type: "textarea", group: "Public-safe summary", rows: 4, placeholder: "How food, movement and social connection support the broader vitality model." },
    ...
    },
    {
      ...
      fields: [
        ...baseMeta,
        { name: "riskScope", label: "Risk scope", type: "checkbox-group", group: "Risk scope", options: [["hbot", "HBOT"], ["sauna", "Sauna / heat"], ["food", "Food"], ["movement", "Movement"], ["data", "Data / privacy"], ["venue", "Venue"], ["media", "Public media"], ["children", "Children or vulnerable people"], ["clinical", "Clinical-adjacent use"]] },
