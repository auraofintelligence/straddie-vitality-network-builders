(function () {
  ...
  window.VITALITY_BUILDERS = [
    ...
    },
    {
      ...
      claimBoundary: "HBOT/PADS evidence lines require qualified health review. The preferred design is mask-fed PADS, not whole-chamber oxygen enrichment, with source-dated repair-biology and safety trails.",
      fields: [
        ...baseMeta,
        ...
        { name: "fireSafety", label: "Fire and atmosphere safety", type: "textarea", group: "Risk, safety and approvals", rows: 4, placeholder: "Keep the default design around air-pressurised chambers with mask-fed breathing gas where possible. Cover ambient oxygen monitoring, grounding, clothing, ignition sources, device instructions, training, emergency procedure and reporting pathway." },
    ...
    },
    {
      ...
      claimBoundary: "Sauna evidence is promising for general wellbeing, heat adaptation and cardiovascular associations; use public copy that stays close to the source trail.",
      fields: [
        ...baseMeta,
    ...
    },
    {
      ...
      claimBoundary: "Use detox language as practical maintenance: exposure reduction, skin-filter care, hydration, minerals, fasting spectrum, recovery, rest and supported healthy behaviours.",
      fields: [
        ...baseMeta,
        ...
        { name: "detoxBoundary", label: "Maintenance and repair boundary", type: "textarea", group: "Evidence and source trail", rows: 4, placeholder: "What can be said about exposure reduction, skin filter care, liver processing, kidney filtering, gut exit routes, sweating, fasting, hydration, minerals and repair biology?" },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "keyRisks", label: "Key risks", type: "textarea", group: "Risk, safety and approvals", rows: 5, placeholder: "Fire, heat stress, pressure effects, contraindications, fasting/refeeding, electrolyte imbalance, food safety, injury, privacy, public wording, cultural authority, insurance." },
