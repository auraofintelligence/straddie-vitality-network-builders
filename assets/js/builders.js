  ...
  window.VITALITY_BUILDERS = [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "deviceStatus", label: "Device status", type: "textarea", group: "Risk, safety and approvals", rows: 3, placeholder: "Device type, ARTG/TGA status if known, pressure range, ambient chamber gas, mask-fed delivery, supplier, service plan, operating instructions." },
        { name: "padsDesign", label: "Mask-fed PADS design", type: "textarea", group: "PADS and sensor architecture", rows: 4, placeholder: "How the sealed mask, gas mixer, pressure regulator, flow controls, mix controls and fail-safes work. Keep the chamber air-pressurised rather than oxygen enriched where possible." },
        { name: "flowMixControls", label: "Flow and mix controls", type: "textarea", group: "PADS and sensor architecture", rows: 4, placeholder: "What can be adjusted, who can adjust it, what limits apply, what gets logged, and what stops the system if readings move outside the safe range?" },
