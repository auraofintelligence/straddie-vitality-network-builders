...
The public front door now keeps the workflow small: start a Straddie wellbeing co-op note, check the venue and prepare funding. Specialist HBOT, sauna, evidence, noticeboard, ledger, media and policy builders remain in the repo for reviewers and agents, but the public journey points people to the source repos that already carry those deeper topics.
...
- `builders/index.html` - three-note co-op starter builder directory
