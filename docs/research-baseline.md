# Straddie Vitality Network Research Baseline
...
- Use "associated with", "may support", "being explored", "requires review" or "evidence is still developing" when evidence is observational, early or mixed.
- Keep HBOT tied to qualified supervision, device instructions, safety controls and health-professional review.
- Prefer mask-fed PADS: an air-pressurised chamber with a Personalised Atmosphere Delivery System that controls breathing gas through a sealed mask rather than enriching the whole chamber.
- Keep sauna tied to heat safety, hydration, screening, supervision and individual tolerance.
- Treat toxicity language as exposure and maintenance work. Prefer "exposure reduction", "risk context", "recovery support", "skin filter care", "source trail" and "measured outcome".
- Put public lines into one of three lanes: evidence-backed now, reasonable hypothesis to test, or review-gated until a qualified reviewer checks it.
...
AIHW estimates 443,274 Australians living with dementia in 2025. AIHW also reports dementia was Australia's leading cause of death in 2023, accounting for almost 17,400 deaths or 9.5% of all deaths. This project should use dated, refreshable evidence rather than far-future forecasts because health policy, technology, care models and community capacity can change quickly.

AIHW and WHO both frame dementia risk through a mix of non-modifiable and modifiable factors. Public planning should focus on safe, evidence-aligned protective behaviours such as physical activity, social engagement, cognitive activity, healthy diet, blood pressure and diabetes management, smoking reduction and avoiding harmful alcohol use.
...
Intermittent fasting is already popular, which makes it important to separate the lanes. Time-restricted eating can be described as a food-timing routine. An added-sugar pause can be described as a lower-risk food-quality reset. Fasting-mimicking diets and 2-5 day no-food fasts should be described as supervised protocols because they can affect glucose, insulin, ketones, blood pressure, medication timing, minerals and refeeding risk.
...
## Public Builder Question Line

The builders should ask:

- What public health or wellbeing need does this respond to?
...
- What source, date, person or organisation does the information come from?

## Source Register

The structured source list lives at `sources/source-register.json`.
